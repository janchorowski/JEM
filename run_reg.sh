...
BASE="/scratch/gobi1/gwohl/REGRESSION3"
...
#          --lr .001 --data_noise ${DN} --weight_decay .0005 --batch_size 128 --mcmc_steps 100 \
#          --n_epochs 50
#
#    echo srun -c 2 --mem=10G -p cpu\
...
#          --n_epochs 250
    ...
    do
        ...
        python regression.py --dataset protein \
          ...
          --loss ml --p_control ${PC} --n_control ${PC} \
          --lr .001 --data_noise ${DN} --mcmc_steps 25 --ebm --weight_decay .0005 --batch_size 128 --mcmc_steps 100 \
          --n_epochs 50
        ...
        python regression.py --dataset protein \
          ...
          --loss ml --p_control ${PC} --n_control ${PC} \
          --lr .001 --data_noise ${DN} --mcmc_steps 25 --ebr --weight_decay .0005 --batch_size 128 --mcmc_steps 100 \
          --n_epochs 50
